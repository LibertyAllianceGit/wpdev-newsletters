<?php 
/**
Variable & Options Setup
**/

// Header Layout
$headlayout = get_post_meta(get_the_ID(), 'newsletter_settings_header_layout', true);
if(!empty($headlayout)) {
    $hlayout = lcfirst($headlayout);
} else {
    $hlayout = 'left';
}
?>
...
<title><?php echo get_bloginfo('name'); ?> Email</title>
...
<table class="head-wrap" bgcolor="#999999">
	<tr>
		<td></td>
		<?php include plugin_dir_path(__FILE__) . 'parts/header-' . $hlayout . '.php'; ?>
		<td></td>
	</tr>
</table><!-- /HEADER -->
